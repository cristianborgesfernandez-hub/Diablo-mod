-- ============================================
-- SCHEMA COMPLETO Diablomod (ACTUALIZADO)
-- ============================================
...
-- Admin inicial
-- ============================================
-- No se inserta un admin por defecto en el schema.
-- Configura PANEL_ADMIN_USER / PANEL_ADMIN_PASS / PANEL_ADMIN_ROLE y deja que la app lo inicialice.
